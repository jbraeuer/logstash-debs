...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "cabin", "0.1.7" # for logging. apache 2 license
  spec.add_dependency "filewatch", "~> 0.3.2"  # for file tailing, BSD License
  ...
  spec.add_dependency "ffi-rzmq", "0.9.0"
